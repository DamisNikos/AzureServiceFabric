    ...
    internal sealed class BadStateful : StatefulService
    {
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                {
                    var result = await myDictionary.TryGetValueAsync(tx, key1);
                    ...
                    await myDictionary.AddOrUpdateAsync(tx, key1, 0, (k, v) => ++v);
                    localValue++;

                    //await myDictionary.AddOrUpdateAsync(tx, key1, 0, (key, value) => ++value);
